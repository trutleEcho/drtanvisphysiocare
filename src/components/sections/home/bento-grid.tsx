...
const BentoCard = ({
  ...
  cta: string;
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-white/5 group-hover:dark:bg-neutral-800/20" />
    </div>
);
